...
`dict[str, Field]` — A dictionary mapping field names to their specifications.
...
`dict[str, Any]` — A dictionary containing the field values.
...
`str` — A JSON string representation of the field values.
