...
| Name | Description |
|---|---|
| `gen_key` | The key of the generator to save. |
| `cursor` | The cursor position to save. Defaults to 0. |
| `state_extra` | Additional state information to save. Defaults to None. |
...
| `gen_key` | The key of the generator associated with the run. |
...
| Name | Description |
|---|---|
| `keys` | The list of generated keys to record. |
| `gen_key` | The key of the generator associated with the runs. |
...
| Name | Description |
|---|---|
| `gen_key` | The key of the generator to filter runs by. Defaults to None. |

**Returns**

`int` — The total count of recorded runs.
...
| Name | Description |
|---|---|
| `gen_key` | The key of the generator to filter params by. Defaults to None. |

**Returns**

`list[dict]` — A list of stored parameter dictionaries.
