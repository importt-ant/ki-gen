...
### `load_generator_by_key(gen_key: str) → dict[str, Any] | None`

Return the stored row for a generator, or None.

---

### `save_generator_by_key(gen_key: str, cursor: int = 0, state_extra: dict[str, Any] | None = None) → None`
...
| `cursor` | Cursor position for the generator state. |
| `state_extra` | Additional state information for the generator. |

---

### `list_generators() → list[dict[str, Any]]`
...
### `get_run(key_id: str) → dict[str, Any] | None`
...
### `recent_runs(n: int = 20, gen_key: str | None = None) → list[dict[str, Any]]`
...
| Name | Description |
|---|---|
| `n` | The number of recent runs to return. |
| `gen_key` | The key of the generator to filter runs by. |
...
### `all_params(gen_key: str | None = None) → list[dict[str, Any]]`
